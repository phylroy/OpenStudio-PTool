...
#start the measure
class Inventory < OpenStudio::Ruleset::ModelUserScript
  ...
  def run(model, runner, user_arguments)
    ...
    runner.registerInfo("Writing CSV report 'inventory.csv'")
    File.open("inventory.csv", 'w') do |file|
...
Inventory.new.registerWithApplication
